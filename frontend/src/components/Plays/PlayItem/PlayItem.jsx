    ...
    */
    ...
    <div className="bg-[#eeeeee] p-3 mr-[2%] mt-[1.6%] 
        ...
        <div className="flex flex-col sm:flex-row">
            ...
            <div className="ml-3 mt-[30px] sm:mt-0 flex flex-col items-center sm:items-start">
                <p className="text-[22px] font-bold">
                    <CustomLink text={play.title} destination={destinationURL}/>
                </p>
                <div className="hidden sm:block mt-1 flex-row justify-start">
